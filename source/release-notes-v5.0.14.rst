...
This release of |pdmdb| is based on `Percona Server for MongoDB 5.0.14-12 <https://www.percona.com/doc/percona-server-for-mongodb/5.0/release_notes/5.0.14-12.html>`_ and `Percona Backup for MongoDB 2.0.2 <https://www.percona.com/doc/percona-backup-mongodb/release-notes/2.0.2.html>`_.

Release Highlights
==================

With this release, `$backupCursor and $backupCursorExtend aggregation stages <https://docs.percona.com/percona-server-for-mongodb/5.0/backup-cursor.html>`_ is now generally available, enabling you to use it for building custom backup solutions.
