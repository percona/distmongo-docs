...
This release of |pdmdb| is based on `Percona Server for MongoDB 4.2.12-13 <https://www.percona.com/doc/percona-server-for-mongodb/4.2/release_notes/4.2.12-13.html>`_ and `Percona Backup for MongoDB 1.4.1 <https://www.percona.com/doc/percona-backup-mongodb/release-notes/1.4.1.html>`_. 		    
