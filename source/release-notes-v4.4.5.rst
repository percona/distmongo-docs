...
================================================================================
*Percona Distribution for MongoDB* 4.4.5
================================================================================
...
This release of |pdmdb| is based on `Percona Server for MongoDB 4.4.5-7 <https://www.percona.com/doc/percona-server-for-mongodb/4.4/release_notes/4.4.5-7.html>`_ and `Percona Backup for MongoDB 1.4.1 <https://www.percona.com/doc/percona-backup-mongodb/release-notes/1.4.1.html>`_.
