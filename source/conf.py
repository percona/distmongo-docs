...
# -*- coding: utf-8 -*-
#
# Percona Distribution for MongoDB documentation build configuration file, created by
# sphinx-quickstart on Tue May  5 15:22:57 2020.
#
...
project = 'Percona Distribution for MongoDB'
...
html_theme_options = {
    ...
    'version_info': {
        ...
        "6.0": "https://docs.percona.com/percona-distribution-for-mongodb/6.0/",
...
#
html_sidebars = {
        '**': ['globaltoc.html', 'searchbox.html', 'localtoc.html', 'logo-text.html', 'edit.html'],
...
latex_documents = [
  ('index', # source start file
   ...
   ' '.join([project, 'Documentation']), # title, such as Percona Distribution for MongoDB Documentation
   copyright, 
...
latex_documents = [
    (master_doc, 'PerconaDistributionforMongoDB.tex', 'Percona Distribution for MongoDB Documentation',
     copyright, 'manual'),
]
...
man_pages = [('index', # source start file
              ...
              ' '.join([project, version, u'Documentation']), # description, such as Percona Distribution for MongoDB 1.2 Documentation
              [copyright], # authors
              1 # manual section
)]
...
texinfo_documents = [
    (master_doc, 'PerconaDistributionforMongoDB', 'Percona Distribution for MongoDB Documentation',
     copyright, 'PerconaDistributionforMongoDB', 'One line description of project.',
     'Miscellaneous'),
]
