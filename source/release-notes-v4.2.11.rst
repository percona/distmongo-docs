...
This release of |pdmdb| is based on `Percona Server for MongoDB 4.2.11-12 <https://www.percona.com/doc/percona-server-for-mongodb/4.2/release_notes/4.2.11-12.html>`_  and `Percona Backup for MongoDB 1.3.4 <https://www.percona.com/doc/percona-backup-mongodb/release-notes/1.3.4.html>`_. 		    
