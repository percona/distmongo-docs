...
If you installed |pdmdb| from the Minor release repository, you must enable the new version repository (e.g. ``pdmdb-4.2.8``) to upgrade. We recommend to use the ``setup`` subcommand:
